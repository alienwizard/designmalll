...
<script type="text/javascript">
  ...
  Stripe.setPublishableKey('pk_test_aJebPPkvK6qECkTmkGSjR2sK');
...
<form action="<?php the_permalink(); ?>" method="POST" id="payment-form">
...
require ''.$_SERVER['DOCUMENT_ROOT'].'/design/wp-content/themes/design6_commerce/lib/init.php';
