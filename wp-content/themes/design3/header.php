 ...
 ?>
	<a href="<?php bloginfo('url'); ?>"><img src="<?php echo $image[0]; ?>"></a>
						...
						<div class="right-field col-md-4">
							<div class="contact">
								<h4><i class="fa fa-envelope-o"></i><?php dynamic_sidebar('header-kontakt-mail'); ?></h4>
								<h4><i class="fa fa-phone-square"></i><?php dynamic_sidebar('header-kontakt-tele');?></h4>
								<h4><i class="fa fa-clock-o"></i><?php dynamic_sidebar('header-kontakt-hour');?></h4>
							</div>
						</div>
					</div>
				</div>
